...
document.addEventListener("DOMContentLoaded", () => {
    ...
    if (inputBusca) {
        inputBusca.addEventListener("input", () => {
            ...
            cards.forEach(card => {
                // Procura o texto que está dentro da classe .brand do card
                const nomeMarca = card.querySelector(".brand").textContent.toLowerCase();

                // Se o nome da marca incluir o termo buscado, mostra o card, senão esconde
                if (nomeMarca.includes(termoBusca)) {
                    card.style.display = "block"; // Volta a exibir o card
                } else {
